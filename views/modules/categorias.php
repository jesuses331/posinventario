    ...
    <main class="content">
        <div class="topbar">
            <div>
                ...
                <div class="text-muted" style="font-size:.92rem">Crear, editar y gestionar categorías de productos.</div>
            </div>
            ...
            <form id="formCategoria">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control themed-input" id="nombre" placeholder="Ej: Accesorios" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label form-label-compact">Descripción</label>
                        <textarea class="form-control themed-input" id="descripcion" rows="3" placeholder="Descripción opcional de la categoría"></textarea>
                    </div>
                </div>
